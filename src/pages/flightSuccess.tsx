  ...
  return (
    <div>
        <div className="flex flex-col items-center justify-center h-screen font-sora">
            ...
            <p className='text-sm text-[#667085]'>You have successfully booked your flight</p>
            <Link href={'/bookings'}><button className="px-32 xl:px-40 py-2 mt-6 text-xs font-medium text-center text-white rounded-xl bg-primary w-fit">
          Continue
        </button></Link>        
        </div>
    </div>
