...
const ThankYouPage = () => {
  ...
  const getProductId = localStorage.getItem("productOrder_id");
    ...
    <div>
      ...
      {showConfetti && (
        <div className="fixed inset-0 pointer-events-none z-50">
          <div className="absolute inset-0">{generateConfetti()}</div>
        </div>
      )}
            ...
            <div className="lg:col-start-2">
              ...
              {order.payment_method === "Bank Transfer" ? (
                <p className="mt-2 text-base text-muted-foreground">
                  ...
                  We've sent the payment instructions to the team.
              ...
              <div className="mt-16 text-sm font-medium">
                ...
                <div className="mt-2 text-gray-900">{getProductId}</div>
                  ...
                  <div className="mt-8 rounded-lg bg-gray-50 px-4 py-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-muted-foreground mt-2">
                        Please use your Order ID ({order.id}) as payment
                        reference
                      </p>
                    </div>
                  </div>
